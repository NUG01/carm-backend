                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <div class="f-fallback" style="text-align:center;">
                                            ...
                                            <p style="font-size:12px; color:#ffffff; text-transform:uppercase;">Accepted</p>
                                            <!-- Action -->
                                                            ...
                                                            <tr>
                                                                <td align="start"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        თუ რაიმე პრობლემა გაქვს, უბრალოდ არ ინერვიულო, საფორთი არ გვაქვს
                                                                      
                                                                    </p>
                                                                    <p
                                                                        style="font-size:16px;font-weight:400;font-family:'Inter',sans-serif;margin-bottom:32px !important;color:#ffffff;">
                                                                       პატივისცემით ჩაჭრილები</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
